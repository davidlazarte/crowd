...
use davidlazarte\Crowd\Contracts\EntrustUserInterface;
use davidlazarte\Crowd\Traits\EntrustUserTrait;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Cache;
use davidlazarte\Crowd\Permission;
use davidlazarte\Crowd\Role;
use Mockery as m;
...
class EntrustUserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testRoles()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->once()->with('crowd.role')
            ->andReturn('role_table_name');
        Config::shouldReceive('get')->once()->with('crowd.role_user_table')
            ->andReturn('assigned_roles_table_name');
        Config::shouldReceive('get')->once()->with('crowd.user_foreign_key')
            ->andReturn('user_id');
        Config::shouldReceive('get')->once()->with('crowd.role_foreign_key')
            ->andReturn('role_id');
    ...
    public function testHasRole()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        Config::shouldReceive('get')->with('crowd.role_user_table')->times(9)->andReturn('role_user');
    ...
    public function testCan()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->with('crowd.role_user_table')->times(11)->andReturn('role_user');
    ...
    public function testCanWithPlaceholderSupport ()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->with('crowd.role_user_table')->times(6)->andReturn('role_user');
    ...
    public function testAbilityShouldReturnBoolean()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->with('crowd.role_user_table')->times(32)->andReturn('role_user');
    ...
    public function testAbilityShouldAcceptStrings()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->with('crowd.role_user_table')->times(8)->andReturn('role_user');
    ...
    public function testDetachAllRoles()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        Config::shouldReceive('get')->with('crowd.role')->once()->andReturn('App\Role');
        Config::shouldReceive('get')->with('crowd.role_user_table')->once()->andReturn('role_user');
        Config::shouldReceive('get')->with('crowd.user_foreign_key')->once()->andReturn('user_id');
        Config::shouldReceive('get')->with('crowd.role_foreign_key')->once()->andReturn('role_id');
    ...
    {
        $permMock = m::mock('davidlazarte\Crowd\Permission');
    ...
    {
        $roleMock = m::mock('davidlazarte\Crowd\Role');
