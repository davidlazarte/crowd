...
trait CrowdUserTrait
{
    ...
    public function cachedGroups()
    {
        ...
        $cacheKey = 'crowd_groups_for_user_'.$this->$userPrimaryKey;
        return Cache::tags(Config::get('crowd.role_member_table'))
    ...
    {   //both inserts and updates
        ...
        Cache::tags(Config::get('crowd.role_member_table'))->flush();
        return $result;
    }
    ...
    public function groups()
    {
        return $this->belongsToMany(
            ...
            Config::get('crowd.members_table'),
